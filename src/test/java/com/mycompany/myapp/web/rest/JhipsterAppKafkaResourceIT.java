...
import com.mycompany.myapp.service.JhipsterAppKafkaConsumer;
...
public class JhipsterAppKafkaResourceIT {
    ...
    @Autowired
    private JhipsterAppKafkaProducer producer;

    @Autowired
    private JhipsterAppKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipsterAppKafkaResource kafkaResource = new JhipsterAppKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipster-app-kafka/publish?message=test"))
